    ...
    <section class="container">
      <form:form modelAttribute="order.customer" class="form-horizontal">
        <fieldset>
          ...
          <div class="form-group">
            <label class="control-label col-lg-2 col-lg-2" for="billingAddress.streetName" />Street Name</label>
            <div class="col-lg-10">
              <form:input id="billingAddress.streetName" path="billingAddress.streetName" type="text" class="form:input-large" />
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-2 col-lg-2" for="billingAddress.doorNo" />Door No</label>
            <div class="col-lg-10">
              <form:input id="billingAddress.doorNo" path="billingAddress.doorNo" type="text" class="form:input-large" />
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-2 col-lg-2" for="billingAddress.areaName" />Area Name</label>
            <div class="col-lg-10">
              <form:input id="billingAddress.areaName" path="billingAddress.areaName" type="text" class="form:input-large" />
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-2 col-lg-2" for="billingAddress.state" />State</label>
            <div class="col-lg-10">
              <form:input id="billingAddress.state" path="billingAddress.state" type="text" class="form:input-large" />
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-2 col-lg-2" for="billingAddress.country" />Country</label>
            <div class="col-lg-10">
              <form:input id="billingAddress.country" path="billingAddress.country" type="text" class="form:input-large" />
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-2 col-lg-2" for="billingAddress.zipCode" />Zip CODE</label>
            <div class="col-lg-10">
              <form:input id="billingAddress.zipCode" path="billingAddress.zipCode" type="text" class="form:input-large" />
            </div>
          </div>
          <div class="form-group">
            <label class="control-label col-lg-2 col-lg-2" for="phoneNumber" />Phone Number</label>
            <div class="col-lg-10">
